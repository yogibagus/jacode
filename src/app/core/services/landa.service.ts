...
export class LandaService {
  ...
  constructor(
    ...
    //   Object.prototype.hasOwnProperty.call(this.userDetail, "safeEmailId")
    // ) {
    //   this.user = {
  ...
  //   if (
  //     this.userDetail != null &&
  //     Object.prototype.hasOwnProperty.call(this.userDetail, "akses") &&
  //     Object.prototype.hasOwnProperty.call(this.userDetail.akses, hakAkses)
  //   ) {
  //     // console.log(this.userDetail.akses[hakAkses]);
  //     if (
  //       Object.prototype.hasOwnProperty.call(this.userDetail.akses, hakAkses) &&
  //       this.userDetail.akses[hakAkses]
  //     ) {
  ...
  //     this.userDetail != null &&
  //     Object.prototype.hasOwnProperty.call(this.userDetail, "akses") &&
  //     Object.prototype.hasOwnProperty.call(this.userDetail, hakAkses)
  //   ) {
  //     if (
  //       Object.prototype.hasOwnProperty.call(this.userDetail, hakAkses) &&
  //       this.userDetail[hakAkses]
  //     ) {
  ...
  //         subAkses
  //       ) &&
  //       this.userDetail.akses[hakAkses][subAkses]
  //     ) {
